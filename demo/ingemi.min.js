...
f.save=function(b){var a,c=this.canvas.width,e=this.canvas.height,d=this.canvas.toDataURL("image/png");b||(b=window.open("","Ingemi","left=0,top=0,width="+c+",height="+e+",toolbar=0,resizable=0"),b.document.write("<title>Ingemi Export Image</title>"),b.document.write("<img id='exportImage' alt='' height='"+e+"' width='"+c+"' style='position:absolute;left:0;top:0'/>"),b.document.close(),a=b.document.getElementById("exportImage"));a.src=d};window.Ingemi=Ingemi;Ingemi.prototype.init=Ingemi.prototype.B;
